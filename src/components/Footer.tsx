export default function Footer() {
  ...
  return (
    <footer className="mt-auto border-t border-parchment-border py-12 px-6 md:px-12 flex flex-col md:flex-row justify-between items-center gap-8 text-center bg-parchment-surface/30">
      <div className="flex flex-col items-center md:items-start gap-2">
        <span className="font-mono text-[11px] text-parchment-muted uppercase tracking-widest">
          play.sidelower.in
        </span>

export default function Hero() {
  return (
    <section className="pt-32 pb-12 px-6 md:px-12 flex flex-col items-center text-center relative overflow-hidden">
      {/* Decorative background element */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-4xl h-64 bg-[radial-gradient(circle,var(--color-parchment-accent)_0%,transparent_70%)] -z-10 blur-3xl opacity-10" />
